...
internal static unsafe class PartyCreator
{
    ...
    private static SimPartyNpc? Spawn(PartyMemberPreset preset, SimWorld world, PartyRole role, Placement placement, ExcelSheet<Item> itemSheet)
    {
        ...
        chara->Mana = 10_000;
        chara->Battalion = 0;
        CharacterFlags.SetHostile((Character*)chara, false);
        CharacterFlags.SetInCombat((Character*)chara, false);
        CharacterFlags.SetPartyMember((Character*)chara, true);
        CharacterFlags.SetAllianceMember((Character*)chara, false);
        CharacterFlags.SetFriend((Character*)chara, false);
        CharacterFlags.SetOffhandDrawn((Character*)chara, false);
        CharacterFlags.SetWeaponDrawn((Character*)chara, false);
