...
{
    [Signature("48 8B C4 44 89 48 20 44 89 40 18 57", UseFlags = SignatureUseFlags.Pointer, ScanType = ScanType.Text, Fallibility = Fallibility.Fallible)]
    public static CreateCharacterAtIndexDelegate CreateCharacterAtIndex { get; private set; } = null!;

    [Signature("83 FA 64 0F 8D ?? ?? ?? ?? 48", UseFlags = SignatureUseFlags.Pointer, ScanType = ScanType.Text, Fallibility = Fallibility.Fallible)]
