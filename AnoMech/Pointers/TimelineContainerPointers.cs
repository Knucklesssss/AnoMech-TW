...
{
    [Signature("E8 ?? ?? ?? ?? 8B D5 48 8D 8B", UseFlags = SignatureUseFlags.Pointer, ScanType = ScanType.Text, Fallibility = Fallibility.Fallible)]
    public static SetModelStateDelegate SetModelState { get; private set; } = null!;

    [Signature("48 89 5C 24 ?? 57 48 83 EC 20 8B FA 4C 8B", UseFlags = SignatureUseFlags.Pointer, ScanType = ScanType.Text, Fallibility = Fallibility.Fallible)]
