...
internal static class BlueScreenChecks
{
    public static void Run()
    {
        ...
        CheckFailure(19.55f, 19.65f, world => world.Party.Get(0)!.Position = Xz(TopP4BlueScreenRules.SpreadPosition(PartyRole.MainTank)), "原本的分散砲線");
        CheckFailure(19.85f, 19.95f, world => world.Party.Get(2)!.Position = new(0, 0, -15), "分攤不足四人");
        CheckFailure(19.85f, 19.95f, world => world.Party.Get(1)!.Position = world.Party.Get(0)!.Position, "分攤不足四人");
        CheckFailure(19.85f, 19.95f, world => world.Party.Get(1)!.Die("missing stack target"), "分攤不足四人");
        CheckFailure(22.28f, 22.35f, world => world.Party.Get(0)!.Position = new(0, 0, 3), "地靈脈第 1 圈");
        CheckFailure(43.48f, 43.55f, world => world.Party.Get(0)!.Position = new(0, 0, 15), "地靈脈第 3 圈");
    ...
    private static void CheckFailure(float injectAt, float resolveAt, Action<SimWorld> inject, string expected)
    {
        ...
        while (world.Elapsed < 56f) world.Tick(0.02f);
